...
public class DeleteMovieServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Movie_category> listmc =  categoryDAO.getMovieCategory(movie_id);
            for (Movie_category movie_category : listmc) {
                mdao.deleteMovieCate(movie_id, movie_category.getCate_id()+"");
            }
            mdao.deleteMovie(movie_id);
            
            response.sendRedirect("admin/addmovie?updaters=true");
